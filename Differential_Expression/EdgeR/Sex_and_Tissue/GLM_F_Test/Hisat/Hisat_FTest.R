...
# Plots/json files
# GENE_MATCHED_UP_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Matched/Gene/Hisat_Upreg_FTest.json'
# GENE_MATCHED_DOWN_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Matched/Gene/Hisat_Downreg_FTest.json'
TRANS_MATCHED_UP_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Age_Matched/Transcript/Hisat_Upreg_FTest.json'
TRANS_MATCHED_DOWN_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Age_Matched/Transcript/Hisat_Downreg_FTest.json'

# GENE_AGE_MATCHED_UP_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Age_Matched/Gene/Hisat_Upreg_FTest.json'
# GENE_AGE_MATCHED_DOWN_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Age_Matched/Gene/Hisat_Downreg_FTest.json'
# TRANS_AGE_MATCHED_UP_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Age_Matched/Transcript/Hisat_Upreg_FTest.json'
# TRANS_AGE_MATCHED_DOWN_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Age_Matched/Transcript/Hisat_Downreg_FTest.json'

# GENE_MATCHED_MD_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Matched/Gene/Hisat_FTest_MD.pdf'
# GENE_MATCHED_VOLCANO_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Matched/Gene/Hisat_FTest_Volcano.pdf'
TRANS_MATCHED_MD_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Matched/Transcript/Hisat_FTest_MD.pdf'
TRANS_MATCHED_VOLCANO_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Matched/Transcript/Hisat_FTest_Volcano.pdf'

# GENE_AGE_MATCHED_MD_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Age_Matched/Gene/Hisat_FTest_MD.pdf'
# GENE_AGE_MATCHED_VOLCANO_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Age_Matched/Gene/Hisat_FTest_Volcano.pdf'
# TRANS_AGE_MATCHED_MD_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Age_Matched/Transcript/Hisat_FTest_MD.pdf'
# TRANS_AGE_MATCHED_VOLCANO_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Hisat/Age_Matched/Transcipt/Hisat_FTest_Volcano.pdf'
