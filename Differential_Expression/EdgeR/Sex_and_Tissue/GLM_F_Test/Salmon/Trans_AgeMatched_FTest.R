...
MD_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Salmon/Age_Matched/Transcript/Salmon_FTest_MD.pdf'
VOLCANO_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Salmon/Age_Matched/Transcript/Salmon_FTest_Volcano.pdf'
UP_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Salmon/Age_Matched/Transcript/Salmon_Upreg_FTest.json'
DOWN_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_F_Test/Salmon/Age_Matched/Transcript/Salmon_Downreg_FTest.json'
...
MD_Plot_Func <- function(x, w){
  ...
  mtext('Salmon: Transcript Mean-Difference Plots; GLM F Test', side = 3, outer = TRUE, cex=1.2, line=3)
...
Plot_Func <- function(a, b, c, d){
  ...
  mtext('Salmon: Transcript Volcano Plots; GLM F Test', side = 3, outer = TRUE,  cex=1.2, line=3)
