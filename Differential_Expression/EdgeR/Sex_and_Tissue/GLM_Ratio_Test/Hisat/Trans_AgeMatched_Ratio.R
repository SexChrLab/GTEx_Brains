...
# Plots/json files
UP_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_Ratio_Test/Hisat/Age_Matched/Transcript/Hisat_Upreg_Ratio.json'
DOWN_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_Ratio_Test/Hisat/Age_Matched/Transcript/Hisat_Downreg_Ratio.json'
MD_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_Ratio_Test/Hisat/Age_Matched/Transcript/Hisat_Ratio_MD.pdf'
VOLCANO_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/GLM_Ratio_Test/Hisat/Age_Matched/Transcipt/Hisat_Ratio_Volcano.pdf'
...
MD_Plot_Func <- function(x, w){
  ...
  mtext('Hisat: Transcript Mean-Difference Plots; GLM Ratio Test', side = 3, outer = TRUE, cex=1.2, line=3)
...
Plot_Func <- function(a, b, c, d){
  ...
  mtext('Hisat: Transcript Volcano Plots; GLM Ratio Test', side = 3, outer = TRUE,  cex=1.2, line=3)
