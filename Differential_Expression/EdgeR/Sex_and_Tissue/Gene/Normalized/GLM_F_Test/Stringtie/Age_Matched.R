...
Contrasts <- c('Amygdala.Female - Amygdala.Male', 'Anterior.Female - Anterior.Male',
                'Caudate.Female - Caudate.Male', 'Cerebellar.Female - Cerebellar.Male',
                'Cortex.Female - Cortex.Male', 'Frontal_Cortex.Female - Frontal_Cortex.Male',
                'Cerebellum.Female - Cerebellum.Male', 'Hippocampus.Female - Hippocampus.Male',
                'Hypothalamus.Female - Hypothalamus.Male', 'Nucleus_Accumbens.Female - Nucleus_Accumbens.Male',
                'Putamen.Female - Putamen.Male', 'Spinal_Cord.Female - Spinal_Cord.Male',
                'Substantia_Nigra.Female - Substantia_Nigra.Male')

Contrast_Func <- function(a, b, c){
  my.contrasts <- makeContrasts(a = b, levels = c)
  return(my.contrasts)
}
GLM_Res <- Map(Contrast_Func, a=Names, b=Contrasts, c=Design)
...
# Fit GLM model
GLM_Func <- function(x, des){
  glmQLFit(x, contrast=des)
}
GLM_Res <- Map(GLM_Func, x=y, des=my.contrasts)
