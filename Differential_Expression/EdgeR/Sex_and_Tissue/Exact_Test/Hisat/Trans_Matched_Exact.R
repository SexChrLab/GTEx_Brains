...
# within each brain tissue type using transcript level counts on the matched samples.
...
# Hisat/stringtie results are stored in seperate matrices because the set of transcripts/genes reported are tissue-specific;
...
# Plots/json files
UP_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/Exact_Test/Hisat/Matched/Transcript/Hisat_Upreg_Exact.json'
DOWN_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/Exact_Test/Hisat/Matched/Transcript/Hisat_Downreg_Exact.json'
MD_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/Exact_Test/Hisat/Matched/Transcript/Hisat_Exact_MD.pdf'
VOLCANO_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/Exact_Test/Hisat/Matched/Transcript/Hisat_Exact_Volcano.pdf'
