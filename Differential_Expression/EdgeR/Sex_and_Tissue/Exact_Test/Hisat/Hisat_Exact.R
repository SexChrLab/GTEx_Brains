...
# TRANS_MATCHED_UP_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/Exact_Test/Hisat/Matched/Transcript/Hisat_Upreg_Exact.json'
# TRANS_MATCHED_DOWN_JSON <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/Exact_Test/Hisat/Matched/Transcript/Hisat_Downreg_Exact.json'
...
TRANS_AGE_MATCHED_VOLCANO_PLOT <- '/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex_and_Tissue/Exact_Test/Hisat/Age_Matched/Transcript/Hisat_Exact_Volcano.pdf'
