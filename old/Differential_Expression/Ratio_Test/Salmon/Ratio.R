...
MD_Plot_Func <- function(x, w){
  ...
  mtext('Salmon: Isoform Mean-Difference Plots; GLM Ratio Test', side = 3, outer = TRUE, cex=1.2, line=3)
...
Plot_Func <- function(RES, TISSUE, UP, DOWN){
  ...
  mtext('Salmon: Isoform Volcano Plots; GLM Ratio Test', side = 3, outer = TRUE,  cex=1.2, line=3)
