...
TABLE_DIR =  '/scratch/mjpete11/GTEx/Data_Exploration/Sex_Tissue_Age/Multidimensional_Scaling/Salmon/Matched_Table'
MDS_K2 = '/scratch/mjpete11/GTEx/Data_Exploration/Multidimensional_Scaling/Salmon/Matched_Plots/Matched_Salmon_MDS_k2.pdf'
MDS_K4 = '/scratch/mjpete11/GTEx/Data_Exploration/Multidimensional_Scaling/Salmon/Matched_Plots/Matched_Salmon_MDS_k4.pdf'
REPS_K2 = '/scratch/mjpete11/GTEx/Data_Exploration/Multidimensional_Scaling/Salmon/Matched_Plots/Matched_Reps_Salmon_MDS_k2.pdf'
REPS_K4 = '/scratch/mjpete11/GTEx/Data_Exploration/Multidimensional_Scaling/Salmon/Matched_Plots/Matched_Reps_Salmon_MDS_k4.pdf'
...
k2_MDS <- Map(MDS_FUN_k2, DGE = DGE_Without_Reps, NAME = names(DGE_Without_Reps), META = Meta_Without_Reps, TOP = 100, DIM=c(1,2))
