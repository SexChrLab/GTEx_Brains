...
setwd("/scratch/mjpete11/GTEx/Data_Exploration/Multidimensional_Scaling/Salmon")
...
TABLE_DIR =  '/scratch/mjpete11/GTEx/Data_Exploration/Sex_Tissue_Age/Multidimensional_Scaling/Salmon/Matched/Transcript/Matched_Table'
MDS_K2 = '/scratch/mjpete11/GTEx/Data_Exploration/Multidimensional_Scaling/Salmon/Matched/Transcript/Salmon_MDS_k2.pdf'
MDS_K4 = '/scratch/mjpete11/GTEx/Data_Exploration/Multidimensional_Scaling/Salmon/Matched/Transcript/Salmon_MDS_k4.pdf'
REPS_K2 = '/scratch/mjpete11/GTEx/Data_Exploration/Multidimensional_Scaling/Salmon/Matched/Transcript/Reps_Salmon_MDS_k2.pdf'
REPS_K4 = '/scratch/mjpete11/GTEx/Data_Exploration/Multidimensional_Scaling/Salmon/Matched/Transcript/Reps_Salmon_MDS_k4.pdf'
...
cts <- read.table(TRANSCRIPT_COUNTS, sep="\t")
...
MDS_FUN_k2 <- function(DGE, NAME, META, TOP) {
  k2_MDS <- plotMDS(DGE,
                    ...
                    col = colors[META[['Sex']]],
                    main = NAME)
  mtext('Salmon MDS Plots: Dimensions 1 and 2; Top 100 Most Variable Transcripts', side=3, outer=TRUE, line=3)
...
MDS_FUN_k4 <- function(DGE, NAME, META, TOP) {
  k4_MDS <- plotMDS(DGE,
                    ...
                    col = colors[META$Sex],
                    main = NAME)
  mtext('Salmon MDS Plots: Dimensions 3 and 4; Top 100 Most Variable Transcripts', side=3, outer=TRUE, line=3)
...
pdf(REPS_K4)
par(mfrow = c(2, 2), cex=0.4, mar = c(3, 2, 2, 6), oma =c(5, 5, 6, 6), xpd=TRUE)
k4_MDS_Reps <- Map(MDS_FUN_k4, DGE = DGE_Reps, NAME = names(DGE_Reps), META = Meta_Reps, TOP = 100)
