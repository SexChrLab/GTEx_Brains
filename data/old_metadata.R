...
filter(Brain_Reps, Sex=='Female') %>% filter(n(Individual_ID) = 11)



# Are there any individuals with replicates across all brain tissues?

# How many females have replicates across all brain tissues?
